...
To run this post locally, ensure you have these files in the same directory as the post.

- [`Project.toml`](./Project.toml)
- [`Manifest.toml`](./Manifest.toml)
- [`CondaPkg.toml`](./CondaPkg.toml)

When running this document, the above files will be modified automatically when installing new packages.
